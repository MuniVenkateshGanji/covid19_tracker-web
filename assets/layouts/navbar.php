                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if (!isset($_SESSION['auth'])) { ?>
                          ...
                          <li class="nav-item">
                              <a class="nav-link" href="tel:+918558893911">Call Helpline</a>
                          </li>
                            <li class="nav-item">
                        ...
                        <?php } else { ?>
                            ...
                            <!--  <li class="nav-item">
                                    <a class="nav-link" href="../home">survey Covid-19</a></li>       -->                                         </li>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="imgdropdown">
                                    <a class="dropdown-item text-muted" href="../verify"><i class="fa fa-user pr-2"></i> Profile</a>
